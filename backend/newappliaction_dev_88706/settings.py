"""
Django settings for newappliaction_dev_88706 project.
...
ROOT_URLCONF = 'newappliaction_dev_88706.urls'
...
WSGI_APPLICATION = 'newappliaction_dev_88706.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newappliaction_dev_88706 API",
    "DESCRIPTION": "API documentation for newappliaction_dev_88706 App",
    "VERSION": "v1",
}
