...
## Project Structure
    ...
    ├── newappliaction_dev_88706  # Django project configurations
...
1. Clone this repo and `cd newappliaction_dev_88706`
...
2. Clone this repo and `cd newappliaction_dev_88706`
